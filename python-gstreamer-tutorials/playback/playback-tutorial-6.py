...
def main():
    ...
    vis_list = Gst.Registry.feature_filter(Gst.Registry.get(),
                                           filter_vis_features, False, None)
    ...
    if vis_list:
        for visualisation in vis_list:
            ...
            if longname.lower().startswith("goo") \
    ...
    vis_plugin = Gst.ElementFactory.make(selected_visualisation[0],
                                         'visualisation')
